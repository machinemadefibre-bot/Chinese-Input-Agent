...
#define APP_KEY_TRANSFER_WINDOW_CLASS_NAME L"ChineseInputAgentKeyWindow"
#define APP_NAME_PROMPT_WINDOW_CLASS_NAME L"ChineseInputAgentNamePrompt"

#define APP_WRAP_KEY_NAME_FORMAT L"ChineseInputAgent %s %016llx"
#define APP_WRAP_KEY_DEFAULT_LABEL L"Key"
