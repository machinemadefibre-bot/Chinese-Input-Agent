...
cl.exe /nologo /W3 /O2 /utf-8 /D_WINDOWS /DHAVE_SECUREZEROMEMORY=1 ^
  /Fe:build\ChineseInputAgent.exe src\main.c src\app_shared.c src\app_storage.c src\app_llm.c src\crypto_box.c third_party\curve25519-donna\curve25519-donna.c build\app.res ^
